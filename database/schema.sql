...
CREATE TABLE dim_campaign (
    ...
    campaign_name TEXT,
    platform_source TEXT CHECK (platform_source IN ('Meta', 'TikTok', 'Google', 'GoogleAnalytics', 'GoogleSearchConsole', 'LinkedIn')),
    objective TEXT,
    metadata JSONB
);
...
CREATE TABLE dim_page (
    ...
    page_name TEXT,
    platform_source TEXT CHECK (platform_source IN ('Meta', 'LinkedIn', 'TikTok')),
    metadata JSONB
);
